...
4. Upload `cassava_navigation_phase_B_dataset.zip` when prompted. The notebook extracts it and finds `phase_B_training_dataset` automatically; do not edit file paths or merge CSVs.
